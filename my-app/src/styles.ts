...
export const styles = StyleSheet.create({
  ...
  unlockTitle: { color: '#111', fontSize: 21, fontWeight: '800', marginBottom: 8 },
  unlockBody: { color: '#555', fontSize: 15, lineHeight: 22, marginBottom: 18 },
  unlockPrimaryButton: {
    height: 50,
    borderRadius: 18,
  ...
  unlockPrimaryText: { color: '#000', fontSize: 17, fontWeight: '800' },
  unlockTextButton: {
    alignSelf: 'center',
    paddingHorizontal: 14,
    paddingVertical: 12,
  ...
  unlockTextButtonLabel: { color: '#555', fontSize: 14, fontWeight: '700' },
  unlockCloseButton: {
    height: 44,
    borderRadius: 16,
    alignItems: 'center',
