...
export const styles = StyleSheet.create({
  ...
  beautySectionTitle: { color: '#fff', fontSize: 14, fontWeight: '800' },
  beautySliderRow: {
    minHeight: 42,
    flexDirection: 'row',
    alignItems: 'center',
  ...
  beautyValueText: { color: '#fff', fontSize: 14, fontWeight: '800' },
  rightPanel: {
    position: 'absolute',
    right: 12,
    top: 0,
