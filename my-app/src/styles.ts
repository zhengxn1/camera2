...
export const styles = StyleSheet.create({
  ...
  flipIconStroke: { borderColor: 'rgba(255,255,255,0.72)' },
  flipIconStrokeActive: { borderColor: '#9cccff' },
  flipIconCapTopRight: {
    position: 'absolute',
    right: 2,
    top: 8,
  ...
  flipIconCap: { backgroundColor: 'rgba(255,255,255,0.72)' },
  flipIconCapActive: { backgroundColor: '#9cccff' },
